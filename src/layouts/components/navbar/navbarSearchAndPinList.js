...
export default {
  pages: {
    ...
    data: [
      // DASHBOARDS
      {title: "Dashboard",        url: "/dashboard/analytics",                icon: "HomeIcon",           is_bookmarked: false},
      ...
      {title: "Clients",                  url: "/apps/client/all",                icon: "ListIcon",           is_bookmarked: false},
      {title: "Client View",                  url: "/apps/client/client-view/268",            icon: "UserIcon",           is_bookmarked: false},
      {title: "Client Edit",                  url: "/apps/client/client-edit/268",            icon: "EditIcon",           is_bookmarked: false},
