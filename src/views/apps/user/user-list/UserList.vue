...
<template>
  ...
  <div id="page-user-list">
    ...
    <div class="vx-card p-6">
      ...
      <!-- <button v-on:click="testt" class="vs-component vs-button vs-button-primary vs-button-filled">Apply</button> -->
          </div>
      <ag-grid-vue
        ref="agGridTable"
  ...
  data () {
    ...
    return {
      ...
      columnDefs: [
        ...
        //   cellClassRules: {
        //   'status-deactivated': function(params) {
        //     return params.value === 'deactivated';
        //   },
        //   'status-active': function(params) {
        //     return params.value === 'active';
        //   },
        //   'status-blocked': function(params) {
        //     return params.value === 'blocked';
        //   },
        //   'status-pending': function(params) {
        //     return params.value === 'pending';
        //   },
        //   'status-inactive': function(params) {
        //     return params.value === 'inactive';
        //   },
        // },
        // cellRenderer: function(params) {
        //   return '<span class="status-chips">' + params.value + '</span>';
        // }
        },
        {
          headerName: 'Actions',
