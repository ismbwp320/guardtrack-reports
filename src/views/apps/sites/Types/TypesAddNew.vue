                ...
                <div class="vx-row">
                    <div class="vx-col w-full">
                      <div class="flex flex-row bg-gray-200">
                        ...
                        <div class="py-2 pr-2 w-1/2">
                           <vs-input v-validate="'required'" type="color" label="Color:" name="position" class="mb-4 mt-5"  v-model="positionData.color" :color="validateForm ? 'success' : 'danger'" />
                        </div>
                      </div>   
                    </div>
                </div>
